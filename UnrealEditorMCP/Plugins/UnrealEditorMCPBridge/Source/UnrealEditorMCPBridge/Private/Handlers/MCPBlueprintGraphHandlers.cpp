...
// ====== 1. blueprint_create_actor_class ======
bool FMCPCreateActorBlueprintClassHandler::Execute(TSharedPtr<FJsonObject> Payload, TSharedPtr<FJsonObject>& OutResult, FString& OutErrorCode, FString& OutErrorMessage)
{
	...
	if (!MCPBlueprintGraphHelpers::IsParentClassActorDerived(ParentClassName, OutErrorCode, OutErrorMessage))
	{
		return false;
	}
